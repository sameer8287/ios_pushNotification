...
import 'package:iosPushNotification/model/push_notification_model.dart';
import 'package:iosPushNotification/notification_badge.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(),
      body: const Center(
        child: Text('iosPushNotification'),
      ),
    );
  }
}
